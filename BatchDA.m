...
% Total Test time
    ...
    tmax=[];
    dDQdV=[];
    % 8 increasing darkness reds for cycle results
    color_array={[255,245,240]./256; [254, 224, 210]./256;[252, 187, 161]./256; ...
        [252,146,114]./256;[251,106,74]./256; [239,59,44]./256; [203,24,29]./256; ...
        [165,15,21]./256; [103,0,13]./256; [90,0,0]./256};
    % 8 increasing darkness blues for cycle results
    color_array_blue={[204,229,255]./256;[153,204,255]./256;[102,178,255]./256;...
        [51,153,255]./256;[0,128,255]./256;[0,102,204]./256;[0,76,153]./256;...
        [0,51,102]./256;[0,25,51]./256;[0,0,0]};
    % Cycle legends2
